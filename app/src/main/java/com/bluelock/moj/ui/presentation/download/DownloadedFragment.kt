package com.bluelock.moj.ui.presentation.download
...
import com.bluelock.moj.adapters.MyAdapter
import com.bluelock.moj.databinding.FragmentDownloadedBinding
import com.bluelock.moj.interfaces.ItemClickListener
...
class DownloadedFragment : BaseFragment<FragmentDownloadedBinding>(), ItemClickListener {
    ...
    private suspend fun refreshFiles() {
        fileList.clear()
        Utils.RootDirectoryMojShow.listFiles()?.let { f ->
            f.forEach {
